...
public class InvoicePDFGenerator {
    ...
    private String getLastDirectory() {
        return SettingsWindow.getGlobalSetting("pdf_last_directory", 
               SettingsWindow.getGlobalSetting("pdf_default_directory", System.getProperty("user.home")));
    }
    ...
    private void saveLastDirectory(String directory) {
        if (directory != null && !directory.trim().isEmpty()) {
            SettingsWindow.setGlobalSetting("pdf_last_directory", directory);
        }
    }
